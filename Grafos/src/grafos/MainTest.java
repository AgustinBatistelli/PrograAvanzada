...
import color.ColorearPrimerColor;
...
//		GrafoMatrizAdyacencia grafo3 = GestorDeArchivos.cargarGrafo("grafoTest.txt");
		...
		Coloreo coloreoMinimo = new ColorearPrimerColor().colorear(grafo3, orden);
		
		for(int i = 0; i < 10000; i++) {
			Orden ordenNuevo = new OrdenAleatorio().generarOrden(grafo3);
			Coloreo coloreoNuevo = new ColorearPrimerColor().colorear(grafo3, ordenNuevo);
